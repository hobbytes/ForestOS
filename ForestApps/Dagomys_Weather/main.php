<div id="DagomysWeather" style="background: url('https://dagomysweather.ru/source/img/walls/wall.jpg?ran=<?echo rand(0,1000);?>') 100% 100% / cover no-repeat fixed;background-color:#f2f2f2; height:100%; width:100%; padding-top:10px; border-radius:0px 0px 5px 5px; overflow:scroll;">
