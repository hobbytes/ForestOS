...
if(isset($_SESSION['loginuser'])){
  ...
  $style="'display','block'";
  $style2="'display','none'";
  echo '<div id=app'.$idprocess.' style="max-width:'.$maxwidth.'; position:absolute; left:'.$left.'; top:'.$top.';" class="windowborder ui-widget-content window windownormal" ><div id=drag'.$idprocess.' class="ui-widget-header dragwindow"><span style="cursor:default; font-variant: all-petite-caps; font-size:17px;"><div style="background-color:transparent;  background-image: url('.$appicon.'); background-size:cover; height:20px; width:20px; margin:0px 3px 0px 3px; float:left;"></div>'.$pname.' </span>
  ...
  <div id='.$idprocess.' class="blurwindowpassive hideallclass" ></div></div></div>';
  ?>
