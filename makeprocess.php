...
if(isset($_SESSION['loginuser'])){
  ...
  function makeprocess($destination,  $idprocess, $param, $key, $name){
    ...
    echo '
    <div id=app'.$idprocess.' style="max-width:'.$maxwidth.'; position:absolute; left:'.$left.'; top:'.$top.'; overflow:hidden;" class="ui-widget-content window windownormal windowborder" tabindex="'.$idprocess.'" wh="" ww="" applength-'.$idprocess.'="0">
