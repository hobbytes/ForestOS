...
function savedisplay<?echo $appid?>(){
  $("#<?echo $appid?>").load("<?echo $folder?>screen.php?scale="+scaleValue+"&rotate="+rotateValue+"&smooth="+smoothValue+"&contrast="+contrastValue+"&brightness="+brightnessValue+"&saturate="+saturateValue+"&controlemode="+getMode+"&windowsize="+windowValue+"&id=<?echo rand(0,10000).'&appname='.$appname.'&destination='.$folder.'&appid='.$appid;?>")
}
