...
if(!empty($choose_lang)){
  ...
  $newgui->newnotification($appname,$language_lang[$_SESSION['loacale'].'_settings_language'],$language_lang[$_SESSION['loacale'].'_save_lang']."<br><span id='restart' style='margin-left: 25%;' class='ui-button ui-widget ui-corner-all'>".$language_lang[$_SESSION['loacale'].'_restart']."</span>");
...
<span onClick="back<?echo $appid;?>();" class="ui-forest" style="background-color:#d8d8d8; color:#000; border-radius:30%; cursor:pointer; font-size:25px; margin-left:5px;"> &#9668 </span><?echo $language_lang[$_SESSION['loacale'].'_settings_language']?></div>
<?php
/*Settings*/
