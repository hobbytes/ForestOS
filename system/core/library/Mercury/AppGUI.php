...
/* Select file from Explorer */
  function SelectFile($AppID, $Name, $Size, $ShowOnly = null, $PlaceHolder = null, $ButtonCaption = "Select File"){
    ...
    echo '<div class="ui-forest-blink" onClick="CallbackSelectFile'.$AppID.'(\'filesource_'.$Name.$AppID.'\', \''.$ShowOnly.'\')" style="background: #ff5655; width: 90%; padding: 10px 5px; margin: 0 5px; text-align: center; color: #fff; border-radius: 5px; cursor: pointer;">'.$ButtonCaption.'</div>';
    echo '</div>';
