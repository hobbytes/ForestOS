...
/* Select file from Explorer */
  function SelectFile($AppID, $Name, $Size, $ShowOnly = null, $PlaceHolder = null, $ButtonCaption = "Select File", $DefaultDirectory = null){
    ...
    echo '<div class="ui-forest-blink" onClick="CallbackSelectFile'.$AppID.'(\'filesource_'.$Name.$AppID.'\', \''.$ShowOnly.'\', \''.$DefaultDirectory.'\')" style="background: #ff5655; width: 90%; padding: 10px 5px; margin: 0 5px; text-align: center; color: #fff; border-radius: 5px; cursor: pointer; word-break: break-word;">'.$ButtonCaption.'</div>';
    echo '</div>';
...
/* Select file Callback */
  function CallbackSelectFile($AppID){
    ...
    echo 'function CallbackSelectFile'.$AppID.'(CallbackObject, ShowOnly, DefaultDirectory){';
    echo 'data = { callback:CallbackObject, showonly:ShowOnly, defaultdirectory:DefaultDirectory };';
