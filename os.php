...
?>
<body class="ui-body backgroundtheme" style="position:fixed; width:100%; height:100%; z-index:-2000; overflow-x:hidden; overflow-y:hidden; transition: all 0.5s ease;">
